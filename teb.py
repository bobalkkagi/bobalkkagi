...
class TEB(Structure):
    _fields_ = [
    # NT_TIB < 0x38
    ("ExceptionList" , c_uint64),                            #0x8 Ptr64 _EXCEPTION_REGISTRATION_RECORD
    ("StackBase", c_uint64),
    ("StackLimit", c_uint64),
    ("SubSystemTib", c_uint64),
    ("FiberData", c_uint64),                                 # datatype union with version(Uint4B) 
    ("ArbitaryUserPointer", c_uint64),
    ("AddrOfTeb", c_uint64), 
    ("EnvironmentPointer", c_uint64),                        #+0x38  
    ("ClientId_UniqueProcess", c_uint64),                    #       ClientId
    ("ClientId_UniqueThread", c_uint64),
    ("ActiveRpcHandle", c_uint64),
    ("ThreadLocalStoragePointer", c_uint64),
    ("ProcessEnvironmentBlock", c_uint64),                   #       Ptr64 _PEB
    ("LastErrorValue", c_uint32),                            #       Uint4B
    ("countOfOwnedCriticalSections", c_uint32),              #0x06c
    ("CsrClientThread", c_uint64)
    ("CsrClientThread", c_uint64),                           #+0x070
    ("Win32ThreadInfo", c_uint64),                           #+0x078
    ("User32Reserved", c_uint32*26),                         #+0x080
    ("UserReserved", c_uint32*5),                            #+0x0e8 [5] Uint4B
    ("WOW32Reserved", c_uint64),                             #+0x100
    ("CurrentLocale", c_uint32),                             #+0x108
    ("FpSoftwareStatusRegister", c_uint64),                  #+0x10c
    ("ReservedForDebuggerInstrumentation", c_uint64*16),     #+0x110 [16] Ptr64 Void
    ("SystemReserved1", c_uint64*30),                        #+0x190 [30] Ptr64 Void
    ...
    ("ActiveFrame", c_uint64),                               #+0x290 _ActivationStack  : _ACTIVATION_CONTEXT_STACK
    ("FrameListCache_Flink", c_uint64)                       #       rameListCache     : Ptr64 _LIST_ENTRY
    ("FrameListCache_Blink", c_uint64)                       #       Ptr64 _LIST_ENTRY
    ("Flags", c_uint32)
    ...
    ("ActivationContextStackPointer", c_uint64),             #+0x2c8 Ptr64 _ACTIVATION_CONTEXT_STACK
    ...
    ("RealClientId_UniqueProcess", c_uint64),                #+0x7d8  RealClientId
    ("RealClientId_UniqueThread", c_uint64),
    ("GdiCachedProcessHandle", c_uint64),                    #+0x7e8
    ("GdiClientPID", c_uint32),                              #+0x7f0
    ("GdiClientTID", c_uint32),                              #+0x7f4
    ("GdiThreadLocalInfo", c_uint64),                        #+0x7f8
    ("Win32ClientInfo", c_uint64*62),                        #+0x800  [62] Uint8B
    ("glDispatchTable", c_uint64*233),                       #+0x9f0  [233] Ptr64 Void
    ("glReserved1", c_uint64*29),                            #+0x1138 [29] Uint8B
    ("glReserved2", c_uint64),                               #+0x1220
    ("glSectionInfo", c_uint64),                             #+0x1228
    ("glSection", c_uint64),                                 #+0x1230
    ("glTable", c_uint64),                                   #+0x1238
    ("glCurrentRC", c_uint64),                               #+0x1240
    ("glContext", c_uint64),                                 #+0x1248
    ...
    ("DeallocationStack", c_uint64),                         #+0x1478
    ("TlsSlots", c_uint64*64),                               #+0x1480 [64] Ptr64 Void
    ("TlsLinks_Flink", c_uint64),                            #+0x1680 _LIST_ENTRY
    ("TlsLinks_Blink", c_uint64)
    ("Vdm", c_uint64),                                       #+0x1690
    ("ReservedForNtRpc", c_uint64),                          #+0x1698
    ("DbgSsReserved", c_uint64*2),                           #+0x16a0 [2] Ptr64 Void
    ("HardErrorMode", c_uint32),                             #+0x16b0
    ("Padding4", c_ubyte*4),                                 #+0x16b4 [4] UChar
    ("Instrumentation", c_uint64*11),                        #+0x16b8 [11] Ptr64 Void
    ...
    ("SubProcessTag", c_uint64),                             #+0x1720
    ("PerflibData", c_uint64),                               #+0x1728
    ("EtwTraceData", c_uint64),                              #+0x1730
    ("WinSockData", c_uint64),                               #+0x1738
    ...
    ("ReservedForPerf", c_uint64),                           #+0x1750
    ("ReservedForOle", c_uint64),                            #+0x1758
    ("WaitingOnLoaderLock", c_uint32),                       #+0x1760
    ("Padding6", c_ubyte*4),                                 #+0x1764 [4] UChar
    ("SavedPriorityState", c_uint64),                        #+0x1768
    ("ReservedForCodeCoverage", c_uint64),                   #+0x1770
    ("ThreadPoolData", c_uint64),                            #+0x1778
    ("TlsExpansionSlots", c_uint64),                         #+0x1780 Ptr64 Ptr64 Void
    ("ChpeV2CpuAreaInfo", c_uint64),                         #+0x1788 Ptr64 _CHPEV2_CPUAREA_INFO
    ("Unused", c_uint64),                                    #+0x1790
    ("MuiGeneration",c_uint32),                              #+0x1798
    ("IsImpersonating",c_uint32),                            #+0x179c
    ("NlsCache", c_uint64),                                  #+0x17a0
    ("pShimData", c_uint64),                                 #+0x17a8
    ("HeapData", c_uint32),                                  #+0x17b0
    ("Padding7", c_ubyte*4),                                 #+0x17b4 [4] UChar
    ("CurrentTransactionHandle", c_uint64),                  #+0x17b8
    ("ActiveFrame", c_uint64),                               #+0x17c0 Ptr64 _TEB_ACTIVE_FRAME
    ("FlsData", c_uint64),                                   #+0x17c8
    ("PreferredLanguages", c_uint64),                        #+0x17d0
    ("UserPrefLanguages", c_uint64),                         #+0x17d8
    ("MergedPrefLanguages", c_uint64),                       #+0x17e0
    ...
    ("TxnScopeEnterCallback", c_uint64),                     #+0x17f0
    ("TxnScopeExitCallback", c_uint64),                      #+0x17f8
    ("TxnScopeContext", c_uint64),                           #+0x1800
    ("LockCount", c_uint32),                                 #+0x1808
    ("WowTebOffset", c_int32),                               #+0x180c
    ("ResourceRetValue", c_uint64),                          #+0x1810
    ("ReservedForWdf", c_uint64),                            #+0x1818
